<x-layout title="About Jerry Janquart | Quartfolio">
    <x-hero />
...
<p class="tinos-regular text-xl mb-5">In practice, that means my work regularly spans the full lifecycle of a project—from design and development to production and delivery.
    ...
    <div class="bg-white text-black p-6 float-left mr-8 mb-6 w-72">
        ...
        <ul class="space-y-2 tinos-regular text-lg leading-tight">
            <li>▪ Editorial design & magazine production</li>
            <li>▪ Website design & Laravel development</li>
            <li>▪ Digital publishing workflows</li>
            <li>▪ Email marketing campaigns</li>
            <li>▪ Data preparation for shipping & fundraising</li>
            <li>▪ Conference websites & printed materials</li>
            <li>▪ Production coordination with printers</li>
            <li>▪ Subscriber systems & customer support</li>
        </ul>
    </div>
