<x-layout :title="$project->title . ' (Magazine ' .  ucfirst($project->type) . ') | Quartfolio'">
    ...
    <x-section.art-layout bg="graphics-bg" class="relative">
        ...
        <div class="grid grid-cols-[1fr_2fr_1fr] gap-6 md:max-w-3xl mx-auto mt-5">
            <div>
                @if ($previous)
                <a class="btn-sm relative w-12 h-12 p-1 mt-3 box-content flex items-center justify-center group bg-black hover:bg-gray-700 ml-2 rounded-none" href="{{ $previous->slug }}">
            ...
            <div class="bg-white text-black p-4 w-fit mx-auto"
                ...
                <p class="tinos-regular text-center text-md tracking-wide uppercase text-black">
                    Magazine {{ $project->type }} &#8212; {{ $project->quarter_label }} {{ $project->year }}
                </p>
                @endif
            ...
            <div class="flex">
                 @if ($next)
                <a class="btn-sm relative w-12 h-12 p-1 mt-3 box-content flex items-center justify-center group bg-black hover:bg-gray-700 mr-2 rounded-none ml-auto" href="{{ $next->slug }}">
