<x-layout title="Contact | Quartfolio">    <x-hero />
    <x-section.art-layout bg="graphics-bg">
        ...
        <section class="max-w-6xl mx-auto px-6 grid lg:grid-cols-[1fr_2fr] gap-12 items-center pt-4">
        
        <!-- Left Column -->
        
            <div class="lg:max-w-7xl md:max-w-3xl max-w-2xl mx-auto text-center py-6 md:mt-4 lg:-mt-30">
        ...
        <!-- Right Column -->
            ...
            method="POST"
            class="space-y-6 bg-white p-8 w-full mb-10 mt-4 mx-auto"
        >
            @csrf
